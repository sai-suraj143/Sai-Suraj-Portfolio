...
const Contact: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const whatsAppURL = `https://wa.me/919848125269?text=${encodeURIComponent(
      whatsAppMessage
    )}`;
              ...
              <ul className="space-y-6">
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <a
                      href="https://wa.me/919848125269" // Replace this with your actual phone number for WhatsApp
                      className="text-white hover:text-purple-400 transition-colors"
                    >
                      +91 98481 25269
                    </a>
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-white">Kurnool AndhraPradesh, 518001</p>
                  </div>
                </li>
              </ul>
            </div>
